      ...
      module StructureDump # :nodoc:
        ...
        def structure_dump # :nodoc:
          ...
          tables = select_values(<<~SQL.squish, "SCHEMA")
            ...
            ORDER BY 1
          SQL
          identity_column_select = supports_identity_columns? ? "identity_column" : "'NO' identity_column"
          tables.each do |table_name|
            ...
            columns = select_all(<<~SQL.squish, "SCHEMA", [bind_string("table_name", table_name)])
              ...
              data_precision, data_scale, data_default, nullable, #{identity_column_select}
        ...
        def structure_dump_column(column) # :nodoc:
          ...
          if column["identity_column"] == "YES"
            # data_default for identity columns is the auto-generated
            # ISEQ$$_<id>.NEXTVAL reference; omit it so the dump is portable
            # across schemas.
