  ...
  module ConnectionAdapters
    module OracleEnhanced
      module DatabaseStatements
        ...
        # Oracle Database does not support `INSERT INTO ... DEFAULT VALUES`.
        # When the model has an identity primary key, fall back to
        # `INSERT INTO ... (<pk>) VALUES (DEFAULT)`, which lets the
        # `GENERATED BY DEFAULT AS IDENTITY` column populate itself.
