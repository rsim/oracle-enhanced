  ...
  module ConnectionAdapters #:nodoc:
    ...
    class OracleEnhancedAdapter < AbstractAdapter
      ...
      NATIVE_DATABASE_TYPES = {
        primary_key: "NUMBER(38) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY",
      ...
      def next_sequence_value(sequence_name)
        # Do nothing for POC identity
      end

      # Returns true for Oracle adapter (since Oracle requires primary key
      # values to be pre-fetched before insert). See also #next_sequence_value.
      def prefetch_primary_key?(table_name = nil)
        # Return false for POC identity
        false
      end
      ...
      def reset_pk_sequence!(table_name, primary_key = nil, sequence_name = nil) #:nodoc:
        ...
        if primary_key && sequence_name
          execute "ALTER TABLE #{quote_table_name(table_name)} MODIFY #{quote_column_name(primary_key)} GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT VALUE)"
        end
      end
