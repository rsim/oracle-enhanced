    ...
    class OracleEnhancedAdapter < AbstractAdapter
      ...
      def prefetch_primary_key?(table_name = nil)
        ...
        if do_not_prefetch.nil?
          ...
          no_pk = !has_primary_key?(table_name, owner, desc_table_name)
          is_identity = supports_identity_columns? && identity_primary_key?(owner, desc_table_name)
          @do_not_prefetch_primary_key[table_name] = do_not_prefetch = no_pk || is_identity
        end
        !do_not_prefetch
      end
